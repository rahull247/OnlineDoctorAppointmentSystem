<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPager.Master" AutoEventWireup="true" CodeBehind="PatientLogin.aspx.cs" Inherits="DocOnline.PatientLogin" %>
...
<h1 style="margin-left:45%; margin-right:40%;">Patient Login</h1>
<table style="margin-left:45%; width: 200px;" cellpadding="10px" cellspacing="10px">
 ...
 <tr>
   <td>
       <asp:TextBox ID="TextBox1" runat="server" Height="24px" Width="156px" placeholder="Patient Username" style="text-align:center" required></asp:TextBox>
     </td>
    </tr>
    <tr>
   <td>
   ...
   <td>
    ...
    <center>
                <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Red" 
                    NavigateUrl="~/PatientRegistration.aspx">Registration For Patient</asp:HyperLink>
    </center>
    </td>
    </tr>
</table>
